...
var links =['https://fonts.googleapis.com/css?family=Baloo+Paaji',
...
minixhr('https://api.github.com/users/AVM88', startPage)
...
function footerComponent () {
  ...
  function template () {
    ...
    <div class="${css.container}">
      <a href="https://gist.github.com/AVM88">
        <i class="${css.icon} fa fa-github" aria-hidden="true"></i>
      </a>
      <a href="mailto:medix647@gmail.com ">
        <i class="${css.icon} fa fa-envelope-square" aria-hidden="true"></i>
      </a>
      <a href="https://www.facebook.com/aleksandar.v.meda">
